<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <!-- Ion.RangeSlider -->
    <link href="{!! asset('public/admin/vendors/normalize-css/normalize.css') !!}" rel="stylesheet">
    <link href="{!! asset('public/admin/vendors/ion.rangeSlider/css/ion.rangeSlider.css') !!}" rel="stylesheet">
    <link href="{!! asset('public/admin/vendors/ion.rangeSlider/css/ion.rangeSlider.skinFlat.css') !!}" rel="stylesheet">
