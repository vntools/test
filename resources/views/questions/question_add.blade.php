...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
        <div class="x_title">
            <h2>Thêm mới câu hỏi<small>Add new question</small></h2>
        ...
        <div class="x_content">
            <br />
            <form data-parsley-validate class="form-horizontal form-label-left" method="POST" action="{{url('admin/question/add')}}">
                {{ csrf_field() }}
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7 col-sm-8 col-xs-12">
                        <textarea name="problem" required class="ckeditor"></textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7 col-sm-8 col-xs-12">
                        <textarea name="answer1" required class="ckeditor"></textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7 col-sm-8 col-xs-12">
                        <textarea name="answer2" required class="ckeditor"></textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7 col-sm-8 col-xs-12">
                        <textarea name="answer3" class="ckeditor"></textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7 col-sm-8 col-xs-12">
                        <textarea name="answer4" class="ckeditor"></textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7 col-sm-8 col-xs-12">
                        <textarea name="explain" class="ckeditor"></textarea>
                    </div>
                </div>
                <script>
                    var options = {
